...
/**
 * This class represents a single player in the game world.
 * 
 * @author Brian Sabzjadid
 */
public class Player extends Sprite
{
    // THE PLAYER HAS AN ID, WHICH WE'LL USE FOR RENDERING
     ...
     */
    public Player(    SpriteType initSpriteType, 
                                    float initX, 	float initY,
                                    float initVx, 	float initVy,
                                    String initState,
                                    int initPlayerId,    int levelCash)
    {
